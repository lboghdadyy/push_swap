...
SRCS=Mandatory/ft_push_swap.c Mandatory/parsing/ft_strchr.c Mandatory/sort/ft_handling.c Mandatory/parsing/ft_checking.c Mandatory/parsing/ft_split.c Mandatory/parsing/ft_strjoin.c Mandatory/parsing/ft_substr.c Mandatory/includes/ft_atoi.c Mandatory/includes/ft_lst_utils.c \
		...
		Mandatory/sort/ft_countinue_the_proccess.c Mandatory/sort/ft_best_move.c Mandatory/sort/ft_shortcuts.c Mandatory/sort/ft_min_max_of_array.c Mandatory/parsing/ft_check_dup.c Mandatory/sort/ft_min_status.c Mandatory/parsing/ft_strlcat.c Mandatory/parsing/ft_strdup.c
...
NAME=push_swap
OBJ=$(SRCS:.c=.o)
BONUS_HEADER= Bonus/includes/push_swap_bonus.h
B_OBJ=$(B_SRCS:.c=.o)
BONUS_NAME=checker
all: $(NAME)
